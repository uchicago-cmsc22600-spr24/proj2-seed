 ...
 *
 * Parse-tree representation of Ovid programs
 *)
...
structure ParseTree =
  struct
    ...
    datatype program
      ...
      | Prog of top_dcl list                    (* Ovid program *)

    and top_dcl
      = MarkDcl of top_dcl mark                 (* source-file mark *)
      | OverloadDcl of id * ovld_ty             (* overload declaration *)
      | InstanceDcl of id * ovld_ty * id        (* overload instance declaration *)
    ...
    and ovld_ty
      ...
      | OvldTy of id list * ty                  (* overload type with optional params *)
